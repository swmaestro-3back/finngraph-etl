...
BEDROCK_REQUEST_TIMEOUT = int(os.getenv("BEDROCK_REQUEST_TIMEOUT", "300"))
...
## 필터 관련 상수
MATERIAL_EVENT_FILTER_PROVIDER = os.getenv("MATERIAL_EVENT_FILTER_PROVIDER", "bedrock")
...
MATERIAL_EVENT_FILTER_MAX_CONCURRENCY = int(
    os.getenv(
        "MATERIAL_EVENT_FILTER_MAX_CONCURRENCY",
        str(MATERIAL_EVENT_FILTER_MAX_WORKERS),
    )
)
...
NEWS_SUMMARY_PROVIDER = os.getenv("NEWS_SUMMARY_PROVIDER", "bedrock")
